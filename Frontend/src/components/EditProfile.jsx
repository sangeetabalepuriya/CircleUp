...
//                     </div>
//                     <input ref={imageRef} onChange={fileChangeHandler} type='file' className='hidden' />
//                     <button onClick={() => imageRef?.current.click()} className='bg-pink-300 p-2 rounded-sm hover:bg-pink-400'>Change photo</button>
//                 </div>
...
//                         onChange={(e) => setInput({ ...input, bio: e.target.value })}
//                         name="bio"
//                         className="w-full h-12 p-2 border rounded focus-visible:ring-transparent"
//                     />
//                 </div>
//                 <div className="mb-4">
...
//                         id="gender"
//                         name="gender"
//                         className="w-30 p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-400"
//                     >
//                         <option value=""></option>
//                         <option value="female">Female</option>
//                         <option value="male">Male</option>
...
//                     {
//                         loading ? (
//                             <button className='w-fit bg-pink-300 hover:bg-pink-400 p-2 rounded-sm '><Loader2 className='mr-r h-4 w-4 animate-spin' />Please wait</button>
//                         ) : (
//                             <button onClick={editProfileHandler} className='w-fit bg-pink-300 hover:bg-pink-400 p-2 rounded-sm '>Submit</button>
//                         )
//                     }
//                 </div>
