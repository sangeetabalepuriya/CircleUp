...
export default function CommentDialog({ open, setOpen }) {
  ...
  // const isFollowing = currentUser ?.following?.includes(selectedPost.author?._id) || false;
...
//       <Dialog.Portal>
//         <Dialog.Overlay className="bg-black/50 fixed inset-0 z-40" />
//         <Dialog.Content className="  bg-neutral-800 outline-none p-2 w-[80%] max-w-2xl mx-auto fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50">
//           <div className="flex flex-col lg:flex-row gap-6">
//             {/* Image */}
//             <div className="w-full h-full lg:w-4/4">
//               <img
...
//                 <div className="flex items-center gap-3">
//                   <Link>
//                     <div className="w-10 h-10 bg-gradient-to-r from-pink-500 to-pink-300 rounded-full flex items-center justify-center">
//                       <span className="text-sm font-bold text-white">{selectedPost?.author?.profilePicture}</span>
//                     </div>
//                   </Link>
//                   <Link>
//                     <span className="text-lg font-semibold text-white">{selectedPost?.author?.username}</span>
//                   </Link>
//                 </div>
...
//                   <Popover.Root>
//                     <Popover.Trigger className="text-white text-xl hover:text-gray-300 focus:outline-none border-none bg-transparent">
//                       ...
//                     </Popover.Trigger>
...
//                         side="right"
//                         align="end"
//                         className="bg-neutral-800 rounded-sm shadow-xl p-4 w-48 z-50 ml-10 mt-32"
//                       >
//                         <div className="flex flex-col items-start gap-2">
//                           <button className=" ml-6 px-4 py-2 text-white focus:outline-none border-none bg-transparent rounded hover:bg-pink-500">Unfollow</button>
//                           <button className="px-4 py-2 text-white rounded hover:bg-pink-500">Add to favorites</button>
//                         </div>
//                       </Popover.Content>
//                     </Popover.Portal>
//                   </Popover.Root>
...
//               {/* Comment Section */}
//               <div className="flex-1 overflow-y-auto max-h-64 pr-2 scrollbar-thin scrollbar-thumb-neutral-600 scrollbar-track-neutral-800">
...
//                 <div className='flex gap-2'>
//                   <input value={text} onChange={changeEventHandler} type="text" placeholder='Add a comment...' className='text-white w-full border border-white outline-none p-2 rounded bg-transparent' />
//                   <button
//                     disabled={!text.trim()}
//                     onClick={sendMessageHandler}
//                     className={`text-white border border-white outline-none p-2 rounded bg-transparent ${!text.trim() ? "opacity-50 " : "hover:bg-white/10"
//                       }`}>Send</button>
//                 </div>
//               </div>
