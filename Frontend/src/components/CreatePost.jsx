...
//               onChange={(e) => setCaption(e.target.value)}
//               placeholder="Write a caption..."
//               className="p-2 border border-gray-300 rounded outline-none resize-none h-24 focus-visible:ring-transparent text-white"
//               required
//             />
//             {
//               imagePreview && (
...
//             }
//             <input ref={imgageRef} onChange={fileChangeHandler} type="file" className='hidden' />
//             <button onClick={() => imgageRef.current.click()} className="bg-pink-500 text-white py-2 rounded hover:bg-pink-400 transition">Select from the computer</button>
//             {
//               imagePreview && (
//                 loading ? (<button
//                   disabled
//                   className="flex items-center justify-center gap-2 w-full text-white bg-pink-500 py-2 rounded hover:bg-pink-400 transition-opacity disabled:opacity-70"
//                 >
//                   <Loader2 className="h-5 w-5 animate-spin" />
//                   Please wait
//                 </button>
...
//                 ) : (
//                   <button onClick={createPostHandler} className='w-full text-white bg-pink-500 py-2 rounded hover:bg-pink-400 transition'>Post</button>
//                 )
//               )
//             }
