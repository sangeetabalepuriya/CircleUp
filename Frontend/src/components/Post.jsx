...
export default function Post({ post }) {
    ...
    async function likeOrDislikeHandler() {
        try {
            ...
            const res = await axios.get(`https://circleup-3wqg.onrender.com/post/${action}/${post?._id}`, { withCredentials: true });
            if (res.data.success) {
    ...
    async function commentHandler() {
        try {
            const res = await axios.post(`https://circleup-3wqg.onrender.com/post/comment/${post._id}`, { text }, {
                headers: {
    ...
    async function deletePostHandler() {
        try {
            const res = await axios.delete(`https://circleup-3wqg.onrender.com/post/delete/${post?._id}`, { withCredentials: true });
            if (res.data.success) {
    ...
    async function bookmarkHandler() {
        try {
            const res = await axios.get(`https://circleup-3wqg.onrender.com/post/bookmark/${post?._id}`, { withCredentials: true });
            if (res.data.success) {
    ...
    async function handleFollowToggle() {
        try {
            const res = await axios.post(
                `https://circleup-3wqg.onrender.com/user/followOrUnFollow/${post.author._id}`,
                {},
                { withCredentials: true }
            );
