...
//             <form onSubmit={signUpHandler} className="bg-white p-8 rounded-2xl shadow-md w-full max-w-sm space-y-6">
//                 <div className="text-center">
//                     <h1 className="text-2xl font-bold text-neutral-950">LOGO</h1>
...
//                 <button
//                     type="submit"
//                     className="w-full bg-neutral-950 text-white py-2 px-4 rounded-lg hover:bg-neutral-800 transition"
//                 >
//                     Login
//                 </button>
//                 <span className="w-full text-center m-10 ">Does't have an account ? <Link  className= "text-blue-600" to="/signup">Signup</Link></span>
//             </form>
//         </div>
//     );
// }
