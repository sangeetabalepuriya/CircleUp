...
export default function Profile() {
    ...
    async function handleFollowUnfollow() {
        try {
            ...
            if (res.data.success) {
                if (isFollowing) {
                    dispatch(unfollowUser(userProfile._id)); // ✅ FIXED
                    toast.success("Unfollowed successfully");
                } else {
                    dispatch(followUser(userProfile._id)); // ✅ FIXED
...
//                                                                 Unfollow
//                                                             </button>
//                                                             <button className="bg-neutral-700 hover:bg-neutral-600 text-white font-medium py-2 px-4 rounded-xl transition-all duration-200 shadow border border-neutral-600">
//                                                                 Message
//                                                             </button>
//                                                         </>
//                                                     ) : (
...
//                                         displayedPost?.map((post) => {
//                                             return (
//                                                 <div key={post?._id} className="relative w-full aspect-square overflow-hidden group rounded-xl bg-neutral-700">
//                                                     <img
//                                                         src={post.image}
//                                                         alt="postimage"
//                                                         className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"
